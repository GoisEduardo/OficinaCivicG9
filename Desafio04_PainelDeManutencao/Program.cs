...
public class Program 
{
    ...
    private static string TrocarOleo()
    {
        const decimal UltimaQuilometragemRegistrada = 110000m;
        const decimal QuilometragemParaTroca = 10000m;

        Console.Write("Qual a quilometragem atual do carro: ");
        decimal quilometragem = Decimal.Parse(Console.ReadLine()!);

        if ((quilometragem - UltimaQuilometragemRegistrada) >= QuilometragemParaTroca)
        {
